...
To do this, we represent each phenotypic term with the top 6 relevant terms. Figure \ref{fig:classificationVarNG} shows the precision, recall and F1 score for classifying phenotypes to their ``significant" or ``not significant" annotator labels using the optimal normalized lift threshold. 
